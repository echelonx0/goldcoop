...
// }
// lib/services/admin_support_service.dart
// ✅ ADDED: updateTicketStatus method for direct status updates
...
class AdminSupportService {
  ...
  /// ✅ NEW: Update ticket status directly
  Future<void> updateTicketStatus({
    ...
    try {
      ...
      log(
        '[AdminSupportService] Ticket status updated: $ticketId -> ${newStatus.name}',
      );
    } catch (e) {
      log('[AdminSupportService] Error updating ticket status: $e');
      rethrow;
    }
  }
