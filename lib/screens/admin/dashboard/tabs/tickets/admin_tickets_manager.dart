// // // lib/screens/admin/support/admin_tickets_manager.dart
...
// //     try {
// //       await widget.adminSupportService.assignTicketToAdmin(
...
// // }
// // lib/screens/admin/support/admin_tickets_manager.dart
// // ✅ FIXED: Ticket status updates now persist correctly
...
//             // ✅ FIXED: Update button now properly updates status in Firestore
//             SizedBox(
//               width: double.infinity,
//               child: ElevatedButton(
//                 onPressed: _isUpdating ? null : _updateStatus,
...
//   // ✅ FIXED: Properly update ticket status in Firestore with correct method call
//   Future<void> _updateStatus() async {
//     setState(() => _isUpdating = true);

//     try {
//       // Update ticket status by calling the correct service method
...
// }
// lib/screens/admin/support/admin_tickets_manager.dart
// ✅ FIXED: Filter by Open status now correctly shows tickets instead of "No tickets found"
